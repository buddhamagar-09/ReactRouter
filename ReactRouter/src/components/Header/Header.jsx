        ...
        <div className="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
          ...
          <div className="flex items-center lg:order-2">
            <button
              ...
              className="text-gray-800 dark:text-white hover:bg-gray-100 dark:hover:bg-slate-800 focus:ring-4 focus:ring-gray-300 dark:focus:ring-slate-600 font-medium rounded-lg text-sm px-4 lg:px-5 py-2 lg:py-2.5 mr-2 transition-colors duration-300"
            >
              {themeMode === "light"
                ? "🌙 Dark Mode"
                : "☀️ Light Mode"}
